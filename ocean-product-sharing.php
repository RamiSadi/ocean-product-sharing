...
final class Ocean_Product_Sharing {
	...
	public function ops_install_ocean_notice() {
		echo '<div class="notice is-dismissible updated">
				<p>' . esc_html__( 'Ocean Product Sharing requires that you use OceanWP as your parent theme.', 'ocean-product-sharing' ) . ' <a href="https://oceanwp.org/">' . esc_html__( 'Install OceanWP Now', 'ocean-product-sharing' ) . '</a></p>
			</div>';
	}
